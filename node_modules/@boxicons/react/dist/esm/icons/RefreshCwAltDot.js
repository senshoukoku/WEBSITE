...
const RefreshCwAltDot = forwardRef(({ pack = 'basic', fill = 'currentColor', opacity, width, height, size = 'base', flip, rotate, removePadding, className, style, ...props }, ref) => {
...
export { RefreshCwAltDot };
export default RefreshCwAltDot;
